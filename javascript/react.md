...
Если комопонет в JSX выражении содержит закрывающий тег, то все что находится внутри будет передано компоненту в свойстве `props.children`. Это свойство только для чтения.
